...
実行して表示されるボタンをクリックしてデータフォルダを表示します。
...
LaTexを使用しない場合はリサーチフロー外で草稿を作成した後、「草稿フォルダを表示する」セルを実行し、表示されるボタンをクリックします。
表示されるフォルダに直接アップロードしてください。

リサーチフロー上で草稿を作成する場合は「草稿フォルダを表示する」セルを実行し表示されるボタンをクリックします。
...
次にグラフの作成を「コードセルで作成する」セルを実行してください。
...
フォルダが表示されたら[図表を作成する](#図表を作成する)と同じように操作し論文の執筆を行ってください。
